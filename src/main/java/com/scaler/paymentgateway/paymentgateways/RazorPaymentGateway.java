...
public class RazorPaymentGateway implements IPaymentGateway {
    ...
    public String createStandardPaymentLink(Long amount, String orderId, String phoneNumber, String name, String email) throws RazorpayException {
        ...
        return payment.get("short_url").toString();// https://razorpay.com/docs/api/payments/payment-links/create-standard?search-string=create%20a%20standard
    }
}
